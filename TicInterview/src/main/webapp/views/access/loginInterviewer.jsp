<%-- 
    Document   : loginInterviewer
    Created on : 24-mar-2017, 17:23:03
    Author     : TictumTarde
--%>
...
<head>
        <title>TIC Interviews | Login Entrevistador</title><meta charset="UTF-8" />
    ...
    <body>
        <div id="loginbox">            
            <form id="loginform" class="form-vertical" action="../Interviewer/PanelInterviewer.html">
                <center><h4>LOGIN ENTREVISTADOR</h4></center>
                ...
                <div class="form-actions">
                    <span class="pull-right"><a type="submit" href="views/interviewer/PanelInterviewer.jsp" class="btn btn-success" /> Entrar</a></span>
                </div>
            </form>
        </div>
