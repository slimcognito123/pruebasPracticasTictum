<%-- 
    ...
    Created on : 24-mar-2017, 18:24:18
    Author     : TictumTarde
--%>
...
<html>
    ...
    <body>
        ...
        <div id="user-nav" class="navbar navbar-inverse">
            <ul class="nav">
                <li  class="dropdown" id="profile-messages" ><a title="" href="#" data-toggle="dropdown" data-target="#profile-messages" class="dropdown-toggle"><i class="icon icon-user"></i>  <span class="text">Bienvenido Manager: XXXXX</span><b class="caret"></b></a>
                    ...
                    <div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Inicio</a>
                        <ul>
                            <li class="active"><a href="PanelManager.jsp"><i class="icon icon-home"></i> <span>Inicio</span></a> </li>
                    ...
                    <div id="content">
                        ...
                        <div id="content-header">
                            <div id="breadcrumb"> <a href="PanelManager.jsp" title="Ir a Inicio" class="tip-bottom"><i class="icon-home"></i> Inicio</a></div>
                        </div>
                        <!--End-breadcrumbs-->
                                    ...
                                    <table class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="taskOptions"><a href="#" class="tip-top"><button class="btn btn-success"> <span class="icon-arrow-right"></span></button></a></td>
                                            </tr>
                                            <tr>
