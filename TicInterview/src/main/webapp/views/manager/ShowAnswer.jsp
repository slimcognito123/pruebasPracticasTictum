<%-- 
    Document   : ShowAnswer
    Created on : 24-mar-2017, 18:25:50
    Author     : TictumTarde
--%>
...
<html>
    <head>
        <title>TIC Interviews | Respuesta</title>
        <meta charset="UTF-8" />
                ...
                <li  class="dropdown" id="profile-messages" ><a title="" href="#" data-toggle="dropdown" data-target="#profile-messages" class="dropdown-toggle"><i class="icon icon-user"></i>  <span class="text">Bienvenido Manager: XXXX</span><b class="caret"></b></a>
                    ...
                    <div id="content">
                        ...
                        <div id="content-header">
                            <div id="breadcrumb"> <a href="PanelManager.jsp" title="Ir a Inicio" class="tip-bottom"><i class="icon-home"></i> Inicio</a><a href="ShowAllAnswers.html" class="">Respuestas de Candidatos</a><a href="#" class="current">Respuesta</a></div>
