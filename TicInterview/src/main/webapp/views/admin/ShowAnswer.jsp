<%-- 
    Document   : ShowAnswer
    Created on : 24-mar-2017, 18:16:11
    Author     : TictumTarde
--%>
    ...
    <body>
        ...
        <div id="content">
            ...
            <div id="content-header">
                <div id="breadcrumb"> <a href="PanelAdmin.html" title="Ir a Inicio" class="tip-bottom"><i class="icon-home"></i> Inicio</a><a href="ShowMyAnswers.html">Respuestas de Candidatos</a><a href="#" class="current">Respuesta</a></div>
