<%-- 
    Document   : ShowAllSchemas
    Created on : 24-mar-2017, 18:14:36
    Author     : TictumTarde
--%>
...
<html>
    <head>
        <title>TIC Interviews | Todas Entrevistas</title>
        <meta charset="UTF-8" />
    ...
    <body>
        ...
        <div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Inicio</a>
            <ul>
                ...
                <li class="active"> <a href="ShowAllSchemas.jsp"><i class="icon icon-info-sign"></i> <span>Entrevistas Creadas</span></a></li>
