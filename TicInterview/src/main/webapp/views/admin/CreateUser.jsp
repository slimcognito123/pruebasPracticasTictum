<%-- 
    Document   : CreateUser
    Created on : 24-mar-2017, 18:10:54
    Author     : TictumTarde
--%>
...
<html>
    <head>
        <title>TIC Interviews | Crear Usuario</title>
        <meta charset="UTF-8" />
    ...
    <body>
        ...
        <div id="user-nav" class="navbar navbar-inverse">
            <ul class="nav">
                ...
                <li class="dropdown" id="menu-messages"><a href="#" data-toggle="dropdown" data-target="#menu-messages" class="dropdown-toggle"><i class="icon icon-cog"></i> <span class="text"> Configuración de Usuarios</span> <b class="caret"></b></a>
                    <ul class="dropdown-menu">
                        <li class="active"><a  title="" href="CreateUser.jsp"><i class="icon-plus"></i> Crear Usuario</a></li>
                        <li class="divider"></li>
        ...
        <div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Inicio</a>
            <ul>
                <li class=""><a href="PanelAdmin.html"><i class="icon icon-home"></i> <span>Inicio</span></a> </li>
        ...
        <div id="content">
            ...
            <div id="content-header">
                <div id="breadcrumb"> <a href="PanelAdmin.jsp" title="Ir a Inicio" class="tip-bottom"><i class="icon-home"></i> Inicio</a><a href="#" class="current"> Crear Usuario</a></div>
                <h1><b>Panel de Administrador</b> | Crear Usuario</h1>
            </div>
            <hr>
            <!--End-breadcrumbs-->
            <div class="container-fluid">

                <form id="recoverform" action="/CreateUser.do" method="post">
                    <div class="controls">
                        <div class="main_input_box">
                            <p>Elige el rol del usuario que vas a crear:</p>
                            <input type="radio" name="rol" value="Entrevistador"> <b>Entrevistador</b><br>
                            <input type="radio" name="rol" value="Manager"> <b>Manager</b><br><br>
                            <p>Rellena el formulario con los datos del usuario:</p>
                            <font color="red" id="info"></font><br/>
                            <input type="text" placeholder="Nombre" />
                            <input type="email" placeholder="Email" />
                            <input id="pass" type="password" placeholder="Contraseña" />
                            <input id="vpass" type="password" placeholder="Repetir Contraseña" onchange="verificar()" />
                        </div>
                    </div><br>
                    <button id="boton" type="submit" class="btn btn-info" disabled/>Añadir Usuario </button>                
                </form>
            </div>
        </div>
    </div>
