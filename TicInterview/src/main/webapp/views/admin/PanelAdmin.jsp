...
<div id="user-nav" class="navbar navbar-inverse">
    <ul class="nav">
        <li class="dropdown" id="profile-messages"><a title="" href="#" data-toggle="dropdown"
                ...
                class="icon icon-user"></i> <span class="text">Bienvenido Administrador: XXX</span><b class="caret"></b></a>
        ...
        <li class="dropdown" id="menu-messages"><a href="#" data-toggle="dropdown" data-target="#menu-messages"
                                                   class="dropdown-toggle"><i class="icon icon-cog"></i> <span
                class="text"> Configuración de Usuarios</span> <b class="caret"></b></a>
            <ul class="dropdown-menu">
...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Inicio</a>
    <ul>
        ...
        <li class=""><a href="ShowAllSchemas.jsp"><i class="icon icon-info-sign"></i>
            <span>Entrevistas Creadas</span></a></li>

        <li class=""><a href="ShowAllAnswers.jsp"><i class="icon icon-sitemap"></i>
            <span>Respuestas de Candidatos</span></a></li>
</div>
<!--sidebar-menu-->
...
<div id="content">
    ...
    <div id="content-header">
        <div id="breadcrumb"><a href="PanelAdmin.jsp" title="Ir a Inicio" class="tip-bottom"><i class="icon-home"></i>
            Inicio</a></div>
    </div>
    <!--End-breadcrumbs-->
            ...
            <div class="widget-content nopadding">
                <table class="table table-striped table-bordered">
                    ...
                    <tr>
                        ...
                        <td class="taskOptions"><a href="/GetAnswer.do?id=<%=entrevista.getId()%>" class="tip-top">
                            <button class="btn btn-success"><span class="icon-arrow-right"></span></button>
                        </a></td>
                    </tr>
                    <% }%>
                    </tbody>
