<%-- 
    Document   : MyProcess
    Created on : 24-mar-2017, 18:18:48
    Author     : TictumTarde
--%>
...
<html>
    <head>
        <title>TIC Interviews | Procesos Superados</title>
        <meta charset="UTF-8" />
    ...
    <body>
        ...
        <div id="user-nav" class="navbar navbar-inverse">
            <ul class="nav">
                <li  class="dropdown" id="profile-messages" ><a title="" href="#" data-toggle="dropdown" data-target="#profile-messages" class="dropdown-toggle"><i class="icon icon-user"></i>  <span class="text">Bienvenido Usuario: XXXXX</span><b class="caret"></b></a>
                    ...
                    <div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Inicio</a>
                        <ul>
                            ...
                            <li class="active"> <a href="MyProcess.jsp"><i class="icon icon-ok-circle"></i> <span>Procesos Superados</span></a></li>
                    ...
                    <div id="content">
                        ...
                        <div id="content-header">
                            <div id="breadcrumb"> <a href="PanelCandidate.jsp" title="Ir a Inicio" class="tip-bottom"><i class="icon-home"></i> Inicio</a><a href="#" class="current">Procesos Superados</a></div>
                            <h1>Procesos Superados</h1>
                        </div>
                        <hr>
                        <div class="container-fluid">
                            <p>Aquí podrás ver todos los procesos en los que te han seleccionado <b>¡Enhorabuena!</b></p>
                            <ul class="list" style="color: #28b779">
                                <li><h5>Desarrollador Front-End</h5></li>
                                <li><h5>Camarero de cafés y limpia polvo de teclados</h5></li>
                            </ul>
                            <!--End-breadcrumbs-->
