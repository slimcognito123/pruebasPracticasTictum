<%-- 
    Document   : ShowMySchemas
    Created on : 24-mar-2017, 18:23:43
    Author     : TictumTarde
--%>
...
<html>
    <head>
        <title>TIC Interviews | Entrevistas creadas</title>
        <meta charset="UTF-8" />
                ...
                <li  class="dropdown" id="profile-messages" ><a title="" href="#" data-toggle="dropdown" data-target="#profile-messages" class="dropdown-toggle"><i class="icon icon-user"></i>  <span class="text">Bienvenido Entrevistador: XXXXX</span><b class="caret"></b></a>
                    ...
                    <div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Inicio</a>
                        <ul>
                            ...
                            <li class="active"> <a href="ShowMySchemas.jsp"><i class="icon icon-info-sign"></i> <span>Entrevistas Creadas</span></a></li>
                    ...
                    <div id="content">
                        ...
                        <div id="content-header">
                            <div id="breadcrumb"> <a href="PanelInterviewer.jsp" title="Ir a Inicio" class="tip-bottom"><i class="icon-home"></i> Inicio</a><a href="#" class="current">Entrevistas Creadas</a></div>
                            ...
                            <div class="widget-box">
                                ...
                                <div class="widget-content nopadding">
                                    <table class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="taskDesc"><a href="#"><i class="icon-info-sign"></i>Desarrollador Front-End - Maquetación en nuevos estándares web, Posicionamiento SEO...</a></td>
                                                <td class="taskOptions"><a href="#" class="tip-top"><button class="btn btn-info"> <span class="icon-upload-alt"></span></button></a></td>

                                            </tr>
                                            <tr>
                                                <td class="taskDesc"><a href="#"><i class="icon-info-sign"></i>Desarrollador Back-End - Valoramos si eres capaz de pasar 48h. programando</a></td>
                                                <td class="taskOptions"><a href="#" class="tip-top"><button class="btn btn-info"> <span class="icon-upload-alt"></span></button></a></td>

                                            </tr>
                                            <tr>
                                                <td class="taskDesc"><a href="#"><i class="icon-info-sign"></i>Camarero de cafés y limpia polvo de los teclados de la oficina</a></td>
                                                <td class="taskOptions"><a href="#" class="tip-top"><button class="btn btn-info"> <span class="icon-upload-alt"></span></button></a></td>
