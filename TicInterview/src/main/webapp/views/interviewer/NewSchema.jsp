<%-- 
    Document   : NewSchema
    Created on : 24-mar-2017, 18:20:06
    Author     : TictumTarde
--%>
                ...
                <li  class="dropdown" id="profile-messages" ><a title="" href="#" data-toggle="dropdown" data-target="#profile-messages" class="dropdown-toggle"><i class="icon icon-user"></i>  <span class="text">Bienvenido Entrevistador: XXXXX</span><b class="caret"></b></a>
                    ...
                    <div id="content">
                        ...
                        <div id="content-header">
                            <div id="breadcrumb"> <a href="PanelInterviewer.jsp" title="Ir a Inicio" class="tip-bottom"><i class="icon-home"></i> Inicio</a><a href="NewSchema.jsp" class="current">Nueva Entrevista</a></div>
                            <h1><b>Generador de Entrevistas</b> | Puedes arrastrar los elementos</h1>
                        </div>
                        <hr>
                        <div class="container-fluid">

                            <form method="POST" action="" id="pregunta" hidden>
                                <input type="text" placeholder="Escribe la pregunta" id="textoPregunta" />
                                <button type="button" id="enviarPregunta" >Aceptar</button>
                            </form>
                            ...
                            <form method="POST" action="" id="terminar" hidden>
                                <button type="button" id="terminarPregunta" >Terminar pregunta</button>
                            </form>
                        </div>
                        <!--End-breadcrumbs-->
                        <div class="container-fluid">
                            ...
                            <div align="right">
                                <form action="intermedia.jsp" method="get">
                                    <button type="submit" >Crear Maqueta</button>
